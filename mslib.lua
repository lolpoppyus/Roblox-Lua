...
do
	...
	function Library:SetWatermarkAlignment(alignment: string)
		if alignment == "Left" then
			WatermarkBackground.AnchorPoint = Vector2.new(0,0)
	...
	function Library:SetWatermarkPosition(Pos: UDim2)
		WatermarkBackground.Position = Pos
	end
end
...
function Library:CreateWindow(WindowInfo)
	...
	function Window:AddTab(...)
		...
		local WarningText
		local WarningStroke
		local WarningUIStroke
		local WarningUICorner
		...
		do
			...
			WarningUICorner = New("UICorner",{
				CornerRadius = UDim.new(0,4),
				Parent = WarningBox
			})
			WarningUIStroke = New("UIStroke",{
				Parent = WarningBox,
